...
const GameChat: React.FC<GameChatProps> = ({
  ...
  return (
    <div>
      <Page
        component="div"
        className="z-50 fixed hide-scrollbar space-y-[50px] bg-blue-100"
        ref={pageRef}
      >
        <Header />
        ...
        <Messagebar
          className="hide-scrollbar bg-gray-500"
          placeholder="Message"
          value={messageText}
          ...
          left={
            ...
            >
              <Icon>
                <MdClose className="w-6 h-6 bg-blue-100" />
              </Icon>
            </Link>
          }
          right={
            ...
            >
              <Icon
                material={<MdSend className="w-6 h-6 fill-black bg-gray-500" />}
                ios={<MdSend className="w-6 h-6 fill-black bg-gray-500" />}
              />
            </Link>
          }
        />
